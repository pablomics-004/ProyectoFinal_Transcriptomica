...
nohup fastqc "${FASTQ}_raw"/*_1.fastq -o "${FASTQ}c_1_raw" > ./logs/fastqc_1_raw_explore.log 2>&1 &
nohup fastqc "${FASTQ}_raw"/*_2.fastq -o "${FASTQ}c_2_raw" > ./logs/fastqc_2_raw_explore.log 2>&1 &
